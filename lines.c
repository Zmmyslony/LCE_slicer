...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "lines", 
        "sources": [
            "/home/michal/GitHub/LCE_slicer/lines.pyx"
        ]
    }, 
    "module_name": "lines"
}
 ...
 *                                     double[:, :] x_field, double[:, :] y_field, float line_width):
 *     cdef int i = 0
 */
struct __pyx_ctuple_int__and_int {
  int f0;
...
static int __pyx_v_5lines_NEIGHBOUR_THRESHOLD;
...
static __pyx_ctuple_int__and_int __pyx_f_5lines_find_next_perimeter(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, float); /*proto*/
static int __pyx_f_5lines_check_proximity(__Pyx_memviewslice, float, int, int); /*proto*/
...
static int __pyx_f_5lines_fill_nearest_neighbours(double, double, __Pyx_memviewslice, double, int, int); /*proto*/
...
static int __pyx_f_5lines_normalize_matrix(__Pyx_memviewslice); /*proto*/
static int __pyx_f_5lines_update_empty_spots(__Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
...
static __pyx_ctuple_int__and_int __pyx_f_5lines_find_next_perimeter(__Pyx_memviewslice __pyx_v_perimeter, __Pyx_memviewslice __pyx_v_empty_elements, __Pyx_memviewslice __pyx_v_filled_elements, __Pyx_memviewslice __pyx_v_x_field, __Pyx_memviewslice __pyx_v_y_field, float __pyx_v_line_width) {
  int __pyx_v_i;
 ...
 *         if empty_elements[perimeter[i, 0], perimeter[i, 1]]:             # <<<<<<<<<<<<<<
 *             # distance_from_filled += 1
 *             # distance_from_filled = abs((perimeter[i, 0] - x_filled) * vy) + abs((perimeter[i, 1] - y_filled) * vx)
 */
 ...
 *             if check_proximity(filled_elements, line_width, perimeter[i, 0], perimeter[i, 1]):             # <<<<<<<<<<<<<<
 *                 return perimeter[i, 0], perimeter[i, 1]
 *         else:
 */
      ...
      __pyx_t_26 = 1;
      __pyx_t_22 = (__pyx_f_5lines_check_proximity(__pyx_v_filled_elements, __pyx_v_line_width, (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_perimeter.data + __pyx_t_23 * __pyx_v_perimeter.strides[0]) ) + __pyx_t_24 * __pyx_v_perimeter.strides[1]) ))), (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_perimeter.data + __pyx_t_25 * __pyx_v_perimeter.strides[0]) ) + __pyx_t_26 * __pyx_v_perimeter.strides[1]) )))) != 0);
      if (__pyx_t_22) {
 ...
 */
      __pyx_t_44 = __pyx_f_5lines_normalize(__pyx_v_vx, __pyx_v_vy);
 ...
 * 
 * 
 * cdef int check_proximity(int[:, :] filled_elements, float line_width, int x, int y):             # <<<<<<<<<<<<<<
 *     cdef float distance = line_width * LINE_SEPARATION
 *     cdef int limit = <int>ceil(distance)
 */

static int __pyx_f_5lines_check_proximity(__Pyx_memviewslice __pyx_v_filled_elements, float __pyx_v_line_width, int __pyx_v_x, int __pyx_v_y) {
  ...
  Py_ssize_t __pyx_t_9;
  Py_ssize_t __pyx_t_10;
  __Pyx_RefNannySetupContext("check_proximity", 0);
 ...
 *     cdef int i = 0
 */
  __pyx_v_distance = (__pyx_v_line_width * __pyx_v_5lines_LINE_SEPARATION);
 ...
 *                     return 0
 */
      __pyx_t_8 = (__pyx_f_5lines_check_index((__pyx_v_filled_elements.shape[0]), (__pyx_v_filled_elements.shape[1]), (__pyx_v_x + __pyx_v_i), (__pyx_v_y + __pyx_v_j)) != 0);
      if (__pyx_t_8) {
      } else {
        __pyx_t_7 = __pyx_t_8;
        goto __pyx_L8_bool_binop_done;
      }
      __pyx_t_8 = (((__Pyx_pow_long(((long)__pyx_v_i), 2) + __Pyx_pow_long(((long)__pyx_v_j), 2)) < powf(__pyx_v_distance, 2.0)) != 0);
      __pyx_t_7 = __pyx_t_8;
 ...
 */
        ...
        __pyx_t_10 = (__pyx_v_y + __pyx_v_j);
        __pyx_t_7 = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_filled_elements.data + __pyx_t_9 * __pyx_v_filled_elements.strides[0]) ) + __pyx_t_10 * __pyx_v_filled_elements.strides[1]) ))) > 0) != 0);
        if (__pyx_t_7) {
 ...
 */
  __pyx_t_3 = __pyx_v_x_int;
  __pyx_t_4 = (__pyx_v_y_int + 1);
  __pyx_v_v = (__pyx_v_v + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field.data + __pyx_t_3 * __pyx_v_field.strides[0]) ) + __pyx_t_4 * __pyx_v_field.strides[1]) ))) * ((1 + __pyx_v_x_int) - __pyx_v_x)) * (__pyx_v_y - __pyx_v_y_int)));
 ...
 *     return v
 */
  __pyx_t_5 = (__pyx_v_x_int + 1);
  __pyx_t_6 = (__pyx_v_y_int + 1);
  __pyx_v_v = (__pyx_v_v + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field.data + __pyx_t_5 * __pyx_v_field.strides[0]) ) + __pyx_t_6 * __pyx_v_field.strides[1]) ))) * (__pyx_v_x - __pyx_v_x_int)) * (__pyx_v_y - __pyx_v_y_int)));
 ...
 * 
 */
  __pyx_t_7 = (__pyx_v_x_int + 1);
  __pyx_t_8 = __pyx_v_y_int;
  __pyx_v_v = (__pyx_v_v + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_field.data + __pyx_t_7 * __pyx_v_field.strides[0]) ) + __pyx_t_8 * __pyx_v_field.strides[1]) ))) * (__pyx_v_x - __pyx_v_x_int)) * ((1 + __pyx_v_y_int) - __pyx_v_y)));
 ...
 *     cdef int y_int = int(floor(y))             # <<<<<<<<<<<<<<
 * 
 *     if check_neighbours(x_int, y_int, empty_elements) < NEIGHBOUR_THRESHOLD:
 */
  __pyx_v_y_int = ((int)floor(__pyx_v_y));
 ...
 * 
 */
  __pyx_t_1 = ((__pyx_f_5lines_check_neighbours(__pyx_v_x_int, __pyx_v_y_int, __pyx_v_empty_elements) < __pyx_v_5lines_NEIGHBOUR_THRESHOLD) != 0);
  if (__pyx_t_1) {
...
static int __pyx_f_5lines_fill_nearest_neighbours(double __pyx_v_x_current, double __pyx_v_y_current, __Pyx_memviewslice __pyx_v_filled_elements, double __pyx_v_line_width, int __pyx_v_x_size, int __pyx_v_y_size) {
  int __pyx_v_x_pos;
  int __pyx_v_y_pos;
  int __pyx_v_limit;
  int __pyx_v_i;
...
static int __pyx_f_5lines_normalize_matrix(__Pyx_memviewslice __pyx_v_matrix) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
...
static int __pyx_f_5lines_update_empty_spots(__Pyx_memviewslice __pyx_v_empty_elements, __Pyx_memviewslice __pyx_v_filled_elements) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 * 
 */
  (void)(__pyx_f_5lines_normalize_matrix(__pyx_v_empty_elements));
...
static PyObject *__pyx_pw_5lines_1generate_lines(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_y_field)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("generate_lines", 1, 5, 5, 1); __PYX_ERR(0, 168, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_desired_shape)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_lines", 1, 5, 5, 2); __PYX_ERR(0, 168, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_perimeter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_lines", 1, 5, 5, 3); __PYX_ERR(0, 168, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_printer)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("generate_lines", 1, 5, 5, 4); __PYX_ERR(0, 168, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "generate_lines") < 0)) __PYX_ERR(0, 168, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("generate_lines", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 168, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("lines.generate_lines", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_x_field), __pyx_ptype_5numpy_ndarray, 1, "x_field", 0))) __PYX_ERR(0, 168, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_y_field), __pyx_ptype_5numpy_ndarray, 1, "y_field", 0))) __PYX_ERR(0, 168, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_desired_shape), __pyx_ptype_5numpy_ndarray, 1, "desired_shape", 0))) __PYX_ERR(0, 169, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_perimeter), __pyx_ptype_5numpy_ndarray, 1, "perimeter", 0))) __PYX_ERR(0, 169, __pyx_L1_error)
...
static PyObject *__pyx_pf_5lines_generate_lines(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_x_field, PyArrayObject *__pyx_v_y_field, PyArrayObject *__pyx_v_desired_shape, PyArrayObject *__pyx_v_perimeter, PyObject *__pyx_v_printer) {
  ...
  __pyx_pybuffernd_perimeter.rcbuffer = &__pyx_pybuffer_perimeter;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x_field.rcbuffer->pybuffer, (PyObject*)__pyx_v_x_field, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 168, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_y_field.rcbuffer->pybuffer, (PyObject*)__pyx_v_y_field, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 168, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_desired_shape.rcbuffer->pybuffer, (PyObject*)__pyx_v_desired_shape, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 168, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_perimeter.rcbuffer->pybuffer, (PyObject*)__pyx_v_perimeter, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 168, __pyx_L1_error)
  }
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_v_perimeter), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 171, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(((PyObject *)__pyx_v_x_field), PyBUF_WRITABLE); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 173, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(((PyObject *)__pyx_v_y_field), PyBUF_WRITABLE); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 174, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_v_desired_shape), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 175, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros_like); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 176, __pyx_L1_error)
  ...
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 176, __pyx_L1_error)
 ...
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_printer, __pyx_n_s_nozzle); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_line_width); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_printer, __pyx_n_s_accuracy); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyNumber_Divide(__pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_6 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 181, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *             break
 */
    __pyx_t_7 = __pyx_f_5lines_find_next_perimeter(__pyx_v_cperimeter, __pyx_v_empty_elements, __pyx_v_filled_elements, __pyx_v_cx_field, __pyx_v_cy_field, __pyx_v_line_width);
 ...
 */
    ...
    __pyx_t_15 = __pyx_v_y_start;
    __pyx_v_vy = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_cy_field.data + __pyx_t_14 * __pyx_v_cy_field.strides[0]) ) + __pyx_t_15 * __pyx_v_cy_field.strides[1]) )));
 ...
 */
    while (1) {
      __pyx_t_16 = ((int)__pyx_v_x_pos);
      __pyx_t_17 = ((int)__pyx_v_y_pos);
      __pyx_t_10 = ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_empty_elements.data + __pyx_t_16 * __pyx_v_empty_elements.strides[0]) ) + __pyx_t_17 * __pyx_v_empty_elements.strides[1]) ))) != 0);
      if (!__pyx_t_10) break;
 ...
 */
      __pyx_t_18 = __pyx_f_5lines_calculate_next_move(__pyx_v_x_pos, __pyx_v_y_pos, __pyx_v_vx, __pyx_v_vy, __pyx_v_cx_field, __pyx_v_cy_field, __pyx_v_empty_elements);
      __pyx_t_6 = __pyx_t_18.f0;
      __pyx_t_19 = __pyx_t_18.f1;
      __pyx_v_vx = __pyx_t_6;
      __pyx_v_vy = __pyx_t_19;
 ...
 * 
 */
        (void)(__pyx_f_5lines_fill_nearest_neighbours(__pyx_v_x_pos, __pyx_v_y_pos, __pyx_v_filled_elements, __pyx_v_line_width, __pyx_v_x_size, __pyx_v_y_size));
 ...
 * 
 */
      __pyx_t_18 = __pyx_f_5lines_add_line(__pyx_v_x_pos, __pyx_v_y_pos, __pyx_v_x_start, __pyx_v_y_start, __pyx_v_vx, __pyx_v_vy, __pyx_v_line_width);
      __pyx_t_19 = __pyx_t_18.f0;
      __pyx_t_6 = __pyx_t_18.f1;
      __pyx_v_x_new = __pyx_t_19;
 ...
 */
      (void)(__pyx_f_5lines_fill_nearest_neighbours(__pyx_v_x_new, __pyx_v_y_new, __pyx_v_filled_elements, __pyx_v_line_width, __pyx_v_x_size, __pyx_v_y_size));
 ...
 */
    (void)(__pyx_f_5lines_update_empty_spots(__pyx_v_empty_elements, __pyx_v_filled_elements));
 ...
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_plt); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 223, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_imshow); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 223, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_filled_elements, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 223, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_20 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_5))) {
 ...
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_plt); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 224, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_show); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 224, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
 ...
 *                    printer: Printer):
 */
  __pyx_tuple__27 = PyTuple_Pack(22, __pyx_n_s_x_field, __pyx_n_s_y_field, __pyx_n_s_desired_shape, __pyx_n_s_perimeter, __pyx_n_s_printer, __pyx_n_s_cperimeter, __pyx_n_s_cx_field, __pyx_n_s_cy_field, __pyx_n_s_empty_elements, __pyx_n_s_filled_elements, __pyx_n_s_line_width, __pyx_n_s_x_size, __pyx_n_s_y_size, __pyx_n_s_x_start, __pyx_n_s_y_start, __pyx_n_s_x_pos, __pyx_n_s_y_pos, __pyx_n_s_x_new, __pyx_n_s_y_new, __pyx_n_s_vx, __pyx_n_s_vy, __pyx_n_s_iterator); if (unlikely(!__pyx_tuple__27)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__27);
  __Pyx_GIVEREF(__pyx_tuple__27);
  __pyx_codeobj__28 = (PyObject*)__Pyx_PyCode_New(5, 0, 22, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__27, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_lines_pyx, __pyx_n_s_generate_lines, 168, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__28)) __PYX_ERR(0, 168, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_printer, __pyx_t_1, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_Printer); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_Printer, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_Import(__pyx_n_s_matplotlib_pyplot, __pyx_t_2, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * cdef double MIN_DISTANCE_COEFFICIENT = 0.5             # <<<<<<<<<<<<<<
 * cdef double LINE_SEPARATION = 0.8
 * cdef int NEIGHBOUR_THRESHOLD = 2
 */
 ...
 * 
 */
  __pyx_v_5lines_NEIGHBOUR_THRESHOLD = 2;
 ...
 *                    printer: Printer):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5lines_1generate_lines, NULL, __pyx_n_s_lines); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_generate_lines, __pyx_t_1) < 0) __PYX_ERR(0, 168, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
